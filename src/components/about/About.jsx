    ...
    return (
        <div className="about">
            ...
            <div className="a-right">
                ...
                <p className="a-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta obcaecati culpa facere voluptatem, exercitationem iure, in, modi itaque perspiciatis doloremque molestiae quam inventore possimus eius labore </p>
